				 ...
				 <div class="col-md-12">
                    <div class="nav-tabs-custom tab-chart dchart-2">
                        <ul class="nav nav-tabs pull-right ui-sortable-handle">
                            <li class="active"><a data-toggle="tab" href="#c0">各年级实验平均得分</a></li>
                            <li class="pull-left header"><span>各年级实验平均得分</span></li>
                        </ul>
...
<!--                 </div> -->
                <div class="row">
				 <div class="col-md-6">
                    <div class="nav-tabs-custom tab-chart dchart-2">
                        <ul class="nav nav-tabs pull-right ui-sortable-handle">
                            <li class="active"><a data-toggle="tab" href="#c2">年级各实验平均分数</a></li>
                            <li class="pull-left header"><span>年级各实验平均分数</span></li>
                        </ul>
						<div class="row">  
						    <div class='col-sm-3'>  
                ...
                <div class="row">
				 <div class="col-md-6">
                    <div class="nav-tabs-custom tab-chart dchart-2">
                        <ul class="nav nav-tabs pull-right ui-sortable-handle">
                            <li class="active"><a data-toggle="tab" href="#c3">班级各实验平均分数</a></li>
                            <li class="pull-left header"><span>班级各实验平均分数</span></li>
                        </ul>
						<div class="row">  
						    <div class='col-sm-3'>  
						        <div class="form-group">  
...
<script src="${ctxStatic}/experiment/js/scoreDataAnalysis.js" type="text/javascript"></script>
...
// 					}
	...
	function render_c2(id) {
        ...
        getC2Data("scoreDataAnalysis/experimentGradeAvgScoreData?gradeId="+gradeId,chart,option);
    }
	...
	function render_c3(id) {
       ...
       getC3Data("scoreDataAnalysis/experimentClassAvgScoreData?gradeId="+gradeId,chart,option);
    }
