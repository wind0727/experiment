...
<body>
	...
	<form:form id="searchForm" modelAttribute="experimentRecord" action="${ctx}/experiment/experimentHistory/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>实验时间：</label>
				<input  name="experimentStarttime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="<fmt:formatDate value="${experimentRecord.experimentStarttime}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false});"/> - 
				<input   name="experimentEndtime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="experimentRecord">
			<tr>
				<td><a href="${ctx}/experiment/experimentHistory/minuteList?id=${experimentRecord.id}">
