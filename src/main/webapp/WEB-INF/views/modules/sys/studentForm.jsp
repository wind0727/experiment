...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/student/">单表列表</a></li>
		<li class="active"><a href="${ctx}/sys/student/form?id=${student.id}">单表<shiro:hasPermission name="sys:student:edit">${not empty student.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:student:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="student" action="${ctx}/sys/student/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="studentNo" htmlEscape="false" maxlength="100" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
