...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/sys/city/">单表列表</a></li>
		<li class="active"><a href="${ctx}/sys/city/form?id=${city.id}">单表<shiro:hasPermission name="sys:city:edit">${not empty city.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="sys:city:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="city" action="${ctx}/sys/city/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
